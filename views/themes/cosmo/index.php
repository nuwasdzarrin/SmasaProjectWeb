...
<html lang="en">
	...
	<div id="body-bg">
		<!-- Top Nav -->
		<nav class="navbar navbar-inverse navbar-fixed-top" id="navigasi">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-7 col-xs-12">
						...
						<div class="header-text">
							<h2 style="color: #ff0; font-weight: bold;padding:10px;"><?=$this->session->userdata('school_name')?></h2>
		...
		<div class="copyright">
			<p><?=copyright(2017, base_url(), $this->session->userdata('school_name'))?></p>
		  	<p>Powered by <a href="http://sekolahku.web.id">sman1ngawi.sch.id</a></p>
		</div>
		<!-- END COPYRIGHT -->
	</div>	
		<!-- Back to Top -->
